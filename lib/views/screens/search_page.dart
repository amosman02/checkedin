  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (ctx, snapshot) {
        void submit(referenceNumber) {
          final referenceList = snapshot.data!.docs;
          searchedBooking.clear();
          searchNotFound = false;
          for (var element in referenceList) {
            if (element.id == referenceNumber.toString().toUpperCase()) {
              setState(() {
                searchedBooking.add(element);
              });
            }
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              if (searchedBooking.isEmpty && searchNotFound == false)
                Container(
              ...
              if (searchedBooking.isEmpty && searchNotFound == true)
                Container(
                  alignment: Alignment.bottomCenter,
                  width: 400,
                  height: 400,
              ...
              if (searchedBooking.isNotEmpty)
                Padding(
                  ...
                  child: SearchResult(
                    ...
                    departureTimestamp: searchedBooking[0]
                        ['departure_timestamp'],
                    ...
                    destinationCountry: searchedBooking[0]
                        ['destination_country'],
                    flightDurationTime: searchedBooking[0]
